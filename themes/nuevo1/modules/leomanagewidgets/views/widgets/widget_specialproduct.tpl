...
*}
<div class="exclusive leomanagerwidgets specialproducts">
								...
								<div class="grid">
									{foreach from=$products item=product name=products}
										{if $product@iteration%$columnspage==1&&$columnspage>1}
											<div class="row">
										{/if}
											<div class="ajax_block_product {if $columnspage == 5}col-md-2-4 col-lg-2-4{else}col-md-{$scolumn}{/if} col-xs-12 col-sp-12 {if $smarty.foreach.products.last}last_item{/if}">
