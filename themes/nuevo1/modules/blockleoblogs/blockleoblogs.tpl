...
<div class="carousel slide" id="{$tabname}" class="blockleoblogs">
	...
	{foreach from=$mblogs item=blogs name=mypLoop}
		<div class="item {if $smarty.foreach.mypLoop.first}active{/if}">
				...
				{/if}
				<div class="blog-item {if $columnspage>1} no-padding col-sp-12 col-xs-6 col-sm-6 col-md-{$scolumn} col-lg-{$scolumn} {/if} blog_block ajax_block_blog {if $smarty.foreach.blogs.first}first_item{elseif $smarty.foreach.blogs.last}last_item{/if}">
