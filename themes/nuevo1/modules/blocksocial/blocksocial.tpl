...
<div id="social_block"> 	
	<ul>
		{if isset($facebook_url) && $facebook_url != ''}
			<li class="facebook">
				<a href="{$facebook_url|escape:html:'UTF-8'}" class="btn-tooltip _blank">
		...
		{if isset($twitter_url) && $twitter_url != ''}
			<li class="twitter">
				<a href="{$twitter_url|escape:html:'UTF-8'}" class="btn-tooltip _blank">
		...
		{if isset($rss_url) && $rss_url != ''}
			<li class="rss">
				<a href="{$rss_url|escape:html:'UTF-8'}" class="btn-tooltip _blank">
        ...
        {if isset($youtube_url) && $youtube_url != ''}
        	<li class="youtube">
        		<a href="{$youtube_url|escape:html:'UTF-8'}" class="btn-tooltip _blank">
        ...
        {if isset($google_plus_url) && $google_plus_url != ''}
        	<li class="google-plus">
        		<a href="{$google_plus_url|escape:html:'UTF-8'}" class="btn-tooltip _blank">
        ...
        {if isset($pinterest_url) && $pinterest_url != ''}
        	<li class="pinterest">
        		<a href="{$pinterest_url|escape:html:'UTF-8'}" class="btn-tooltip _blank">
