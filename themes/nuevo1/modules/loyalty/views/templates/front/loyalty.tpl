		...
		{if $orders|@count > $nbpagination}
			<form class="showall" action="{$pagination_link}" method="get">
				<div>
					...
					<input class="form-control" name="n" id="nb_item" class="hidden" value="{$orders|@count}" />
...
<ul class="footer_links clearfix">
	...
	<li class="pull-right">
		<a class="btn btn-outline button button-small" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{l s='Home' mod='loyalty'}"><span><i class="fa fa-home"></i>{l s='Home' mod='loyalty'}</span></a>
	</li>
</ul>
