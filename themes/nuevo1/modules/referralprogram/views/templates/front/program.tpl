...
<ul class="footer_links clearfix">
	...
	<li class="pull-right"><a class="btn btn-outline button button-small" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{l s='Home' mod='referralprogram'}"><span><i class="fa fa-home"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
