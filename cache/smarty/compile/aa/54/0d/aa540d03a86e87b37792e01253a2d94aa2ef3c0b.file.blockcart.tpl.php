<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 13:51:44
         compiled from "C:\xampp\htdocs\tienda3\themes\nuevo1\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2230257ab77c03ac540-14543417%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa540d03a86e87b37792e01253a2d94aa2ef3c0b' => 
    array (
  ...
  'nocache_hash' => '2230257ab77c03ac540-14543417',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab77c06a22f7_77479389',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab77c06a22f7_77479389')) {function content_57ab77c06a22f7_77479389($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\tienda3\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'C:\\xampp\\htdocs\\tienda3\\tools\\smarty\\plugins\\function.counter.php';
?>
<!-- MODULE Block cart -->
...
" rel="nofollow">
				<div class="cart-inner media-body">
					...
					<span class="ajax_cart_product_txt_s" <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<=1) {?>style="display:none"<?php }?>><?php echo smartyTranslate(array('s'=>'Items','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					<span class="ajax_cart_product_txt" <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>1) {?>style="display:none"<?php }?>><?php echo smartyTranslate(array('s'=>'Item','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					<span class="ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'0 Item','mod'=>'blockcart'),$_smarty_tpl);?>
</span>					
					</div>
					<span class="title"><?php echo smartyTranslate(array('s'=>'Shopping bag','mod'=>'blockcart'),$_smarty_tpl);?>
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
						...
						<p class="cart-buttons clearfix">
							<a id="button_order_cart" class="btn btn-outline button-medium button button-small pull-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
...
">
					...
					<a class="btn btn-outline-inverse button pull-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
